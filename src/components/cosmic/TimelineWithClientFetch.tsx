  ...
  return (
    <div className="min-h-screen bg-deep-space flex items-center justify-center">
      <div className="text-center max-w-md px-6">
        ...
        <h2 className="text-xl font-display mb-2">Unable to load timeline</h2>
...
export function TimelineWithClientFetch() {
  const { data, error, isLoading, mutate } = useAPODRange();
  ...
  return <CosmicTimeline allApodData={data} />;
}
